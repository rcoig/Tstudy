...
rownames2 <- c("PARAMETER", "AUC 0-48 (ng*h)/ml", "AUC 0-4 (ng*h)/ml", 
               "Cmax (ng/ml)", "CL/F (L/min)", "Half-life (h)", "AUC 0-inf (ng*h)/ml","Vd/F (L)", "Tmax (h)")
...
Table3 <- cbind(results_Umed_1, results_Ugeo_1, results_Umean_1,
                ...
                results_UGMR1_2, results_UGMR1_3, Table3)
