...
```{r}
parameters <- c("AUClast", "AUC4", "Cmax", "Cl_obs", "HL_Lambda_z", "AUCINF_obs", "Vz_obs", "Tmax")
GMR_parameters <- c("AUClast_ratio", "AUC4_ratio", "Cmax_ratio", "Cl_obs_ratio", "HL_Lambda_z_ratio", "AUCinf_ratio", "Vz_obs_ratio")
```
...
```
Calculate GMRs and 90% CI.
```{r}
source("_source/geometric_mean_90CI.R")
# Compute geometric mean ratios for visit 1 vs visit 2 and visit 1 vs visit 3
results_GMR1_2 <- sapply(GMR_parameters, function(col) geo90(PK_analysis_wide[[paste0(col, "1_2")]]))
results_GMR1_3 <- sapply(GMR_parameters, function(col) geo90(PK_analysis_wide[[paste0(col, "1_3")]]))

# Add Tmax_GMR as "NA"
results_GMR1_2 <- as.data.frame(c(results_GMR1_2, Tmax_GMR1_2 = "NA"))
results_GMR1_3 <- as.data.frame(c(results_GMR1_3, Tmax_GMR1_3 = "NA"))
```
...
save(results_mean_1,results_mean_2,results_mean_3,results_med_1,results_med_2,results_med_3, results_geo_1,results_geo_2,results_geo_3,results_GMR1_2,results_GMR1_3, file = "_output/results_plasma.RData")
